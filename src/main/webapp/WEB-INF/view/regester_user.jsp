			...
			<div class="row">
				<div class="col-sm-8  "id="frmdangky1">
					<div class="signup-form" ><!--sign up form-->
						...
						<span class="text-right" id="goback">Đã có tài khoản đăng nhập</span>
						<form:form  action="dangky" id="frmdangky" modelAttribute="dangkyuser" method ="post">
							...
							<span class="text-danger" id="hoten-error">${error_hotendk}</span>
							<label>Email</label>
